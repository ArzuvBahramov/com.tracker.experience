...
public class TrackerExperienceServiceTest {
    ...
    @BeforeEach
    public void setupTrackerExperienceRequest() {
    ...
    public void textTrackerTechnologies() {
        ...
        assertNotNull(experience.name(), "Technology is not exists");
        assertEquals(experience.experience(), 2);
        assertEquals(experience.year(), 2021);
    }
}
